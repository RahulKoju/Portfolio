...
export const info = {
    ...
    summary:
        "I’m a dedicated Software Developer with hands-on experience in building scalable, user-focused web applications using Next.js, Laravel, and TypeScript. Currently working at Lipi Point, I focus on modern frontend architecture, API integration, and performance optimization, delivering clean, maintainable, and efficient solutions using tools like ShadCN UI, React Query, React Hook Form, and Tailwind CSS. I’m committed to continuous growth, always exploring new technologies in DevOps, system scalability, and software design best practices to deliver impactful digital experiences.",
    short_summary:
        "I’m a dedicated Software Developer with a strong foundation in both frontend and backend development. My expertise includes modern web frameworks like Next.js, React, and Laravel, along with experience working with databases, APIs, and development tools to build scalable and maintainable applications.",
    project_description:
    ...
    hobby: ["Coding", "Open Source Contributions", "Travelling", "Photography"],
    socials: [
        {
            name: "Linkedin",
    ...
    skills: {
        ...
        frameworks_libraries: [
            ...
            {
                name: "Laravel",
                icon: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Laravel.svg/462px-Laravel.svg.png",
            },
            {
                name: "Node.js",
    ...
    projects: [
        {
            ...
            description:
                "<p>A web platform that allows job seekers and students to create <strong>ATS-friendly, professionally designed resumes</strong> within minutes. The platform focuses on delivering an effortless resume creation experience with seamless customization, multiple templates, and fast PDF exports.</p><ul><li><p>Managed <strong>state efficiently</strong>, including handling <strong>props drilling</strong>, <strong>global state management</strong>, and <strong>user authentication/authorization</strong> for different roles.</p></li><li><p>Implemented <strong>step-by-step guided forms</strong> to allow users to create multiple CVs seamlessly for different job titles and profiles.</p></li><li><p>Developed a <strong>highly interactive UI</strong> with responsive design, modern UI/UX principles, and accessibility considerations across devices.</p></li><li><p>Integrated and <strong>handled APIs</strong> ensuring smooth frontend-backend communication.</p></li><li><p><strong>Optimized frontend performance</strong> and best practices for a fast, reliable, and user-friendly experience.</p></li></ul>",
        ...
        },
        {
            ...
            description:
                "<p>A digital news platform consolidating trusted Nepali and international sources, delivering timely and reliable information across categories such as politics, business, culture, sports, and more.</p><ul><li><p>Developed a <strong>scalable content architecture</strong> to aggregate and publish trusted news feeds in a unified portal.</p></li><li><p>Implemented a <strong>responsive and interactive UI</strong> for seamless access on both mobile and desktop devices.</p></li><li><p>Applied <strong>performance, SEO, and accessibility optimizations</strong> to enhance visibility, speed, and usability.</p></li><li><p>Handled <strong>state management, API integrations, and content rendering</strong> efficiently to deliver smooth user experiences.</p></li><li><p>Enabled readers to access <strong>curated, bias-aware, language-specific news</strong>, fostering informed communities in Nepal and beyond.</p></li></ul>",
        ...
        },
        {
            ...
            subtitle: "",
            description:
                "<ul><li><p>Built a performant HTTP server from scratch in Node.js using TCP sockets.</p></li><li><p>Implemented features like gzip compression, robust error handling, and asynchronous file handling for efficient performance.</p></li></ul><p></p>",
            start_date: null,
            end_date: "2024-07-01",
            date_format_input_type: "Year/Month",
            links: [
    ...
    education: [
        {
            ...
            degree: "Bachelors of Science in Computer Science and Information Technology (B.Sc. CSIT)",
