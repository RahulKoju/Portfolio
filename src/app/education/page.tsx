        ...
        <div className="w-full h-fit flex">
          ...
          >
            <div className="text-2xl font-rubik max-sm:text-xl">
              ...
              Technology (B.Sc. CSIT), <br /> Tribhuvan University Kathmandu
            </div>
            <p className=" font-poppins text-base w-full text-primary  max-sm:text-xs">
              I am currently Studying Bachelors of Science in Computer Science
              and Information Technology from Bhaktapur Multiple Campus, a
              Goverment College of Bhaktapur. The program has provided me with a
